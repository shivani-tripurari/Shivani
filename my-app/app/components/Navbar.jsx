          ...
          <div className='text-xl text-[#0E100F] fixed absolute top-0 right-0 w-screen h-screen p-4 bg-[#ededed]'>
            ...
            <main className='flex items-start justify-center h-screen text-2xl font-bold text-black'>
              <ul className='p-7'>
                ...
                <Link href='/'><li className='p-7 hover:scale-125'>Services</li></Link>
                <Link href='/'><li className='p-7 hover:scale-125'>Clients</li></Link>
                <Link href='/'><li className='p-7 hover:scale-125'>Projects</li></Link>
